...
(function() {
  ...
  HMAC_SHA1 = (function() {
    ...
    HMAC_SHA1.prototype.build_base_raw = function(req_url, parsed_url, method, params) {
      var sig;
    ...
    HMAC_SHA1.prototype.build_signature_raw = function(req_url, parsed_url, method, params, consumer_secret, token) {
      var sig_str;
      sig_str = this.build_base_raw(req_url, parsed_url, method, params);
      return this.sign_string(sig_str, consumer_secret, token);
    };

    HMAC_SHA1.prototype.build_signature = function(req, body, consumer_secret, token) {
      var sig_str;
      sig_str = this.build_base(req, body);
      return this.sign_string(sig_str, consumer_secret, token);
    }

    HMAC_SHA1.prototype.build_base = function(req, body) {
      ...
      return this.build_base_raw(hitUrl, parsedUrl, req.method, body);
    };
